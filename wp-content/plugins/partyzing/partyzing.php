...
require_once (plugin_dir_path(__FILE__).'partyzing-cpt.php');
...
function us_admin_enqueue_script(){
	...
	if(($pagenow=="post.php")||($pagenow=="post-new.php")){
		wp_enqueue_style('par_boothstrap','http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css');
		wp_enqueue_script('par_boothstrapjs','http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js');
	...
	// wp_enqeue_script('mcp-media',plugins_url('js/mcp-media.js',__FILE__));
